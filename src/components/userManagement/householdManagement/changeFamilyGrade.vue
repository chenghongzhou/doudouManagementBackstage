            ...
            <div class="setForm">
                <el-form :model="form">
                    <p class="bindingTitle" style="color:red;">
                        用户须知：
                        <br>
                        1、请参考右侧表格(+或-荣耀值)进行调整家族等级！
                        <br>
                        2、增加荣耀值可升级家族等级；负值为扣除荣耀值，降低家族等级！
                    </p>
                ...
                <div slot="footer" class="dialog-footer">
                    <el-button 
                    @click="cancelFamily()">取 消</el-button>
                    <el-button 
                    type="primary" 
                    @click="gradeFamily()">确 定</el-button>
                </div>
            </div>
            <div class="familyRule">
                <template>
                    <el-table border :data="tableData" style="width:100%">
                        <el-table-column prop="date" label="家族等级"></el-table-column>
                        <el-table-column prop="name" label="荣耀值" width="180"></el-table-column>
                        <el-table-column prop="address" label="人数上限"></el-table-column>
                    </el-table>
                </template>
            </div>
        </div>
