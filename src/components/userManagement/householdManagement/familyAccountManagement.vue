	...
	methods: {
        ...
        */ 
		...
		getTableManage() {
            ...
            var url = wechatget+'/server/index.php/Family/getFamilyMasterInfoList';
            var params = {};
        ...
        addAccountSure(type) {
            ...
            if(type==0) {//取消
                ...
                var url = wechatget+'/server/index.php/Family/addFamilyMasterPassTicket';
                var params = {
        ...
        oneBtn(type) {
            ...
            if(type==0) {
                ...
                var url = wechatget+'/server/index.php/Family/addFamilyMasterMember';
                var params = {
        ...
        threeBtn(type) {
            ...
            if(type==0) {
                ...
                var url = wechatget+'/server/index.php/Family/resetFamilyMasterPassWord';
                var params = {
        ...
        fourBtn(type) {
            ...
            if(type==0) {
                ...
                var url = wechatget+'/server/index.php/Family/delFamilyMasterPassTicket';
                var params = {
        ...
        */
        ...
        getAccountTable() {
            var _this = this;
            var url = wechatget+'/server/index.php/Family/getFamilyMasterMemberInfoList';
            var params = {
        ...
        getOneAccount() {
            var _this = this;
            var url = wechatget+'/server/index.php/Family/getFamilyMasterMemberDataList';
            var params = {
        ...
        Unbind(row, index) {
            ...
            var url = wechatget+'/server/index.php/Family/delFamilyMasterMemberShip';
            var params = {
