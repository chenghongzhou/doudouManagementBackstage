...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            if(params.find!==null&&params.find!==''||params.pay_account!==null&&params.pay_account!==''||params.identity_card!==null&&params.identity_card!==''){
        ...
        surePass() {
            var _this = this;
            let url = allget+"/NewUser/passRealName";
            let params = {
                uid: this.passUid,
        ...
        sureRefuse() {
            var _this = this;
            let url = allget+"/NewUser/failRealName";
            let params = {
                uid: this.refuse.uid,
                auth_user: this.operate_user,
        ...
        sureRevamp() {
            var _this = this;
            let url = allget+"/NewUser/editRealName";
            let params = {
                uid: _this.info.uid,
        ...
        sureClear() {
            var _this = this;
            let url = allget+"/NewUser/clearRealName";
            let params = {
                uid: this.clear.uid,
                auth_user: this.operate_user,
            };
