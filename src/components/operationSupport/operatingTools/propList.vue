        ...
        */ 
        ...
        sureAddTwo(type) {
            ...
            if(type==0) {
                ...
                var url = allget+'/NewProp/addPropAttireList';
        ...
        sureEditTwo(type) {
            ...
            if(type==0) {
                ...
                var url = allget+'/NewProp/editPropAttireList';
                axios.post(url, formData, config)
                    .then((res) => {
                        if(res.data.ret) {
                            baseConfig.successTipMsg(_this, res.data.msg);
        ...
        */ 
        ...
        sureAddThree(type) {
            ...
            if(type==0) {
                ...
                var url = allget+'/NewProp/addPropCarList';
                axios.post(url, formData, config)
                    .then((res) => {
                        if(res.data.ret) {
                            baseConfig.successTipMsg(_this, res.data.msg);
        ...
        sureEditThree(type) {
            ...
            if(type==0) {
                ...
                var url = allget+'/NewProp/editPropCarList';
                    axios.post(url, formData, config)
                    .then((res) => {
                        if(res.data.ret) {
                            baseConfig.successTipMsg(_this, res.data.msg);
