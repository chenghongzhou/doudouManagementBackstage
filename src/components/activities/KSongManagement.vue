	...
	<section>
			...
			<template>
				...
				:height="searchPageHeight">
					...
					<el-table-column prop="charm" label="魅力值"></el-table-column>
					<el-table-column prop="like" label="获赞数"></el-table-column>
...
export default {
	...
	methods: {
		...
		getData() {
			var _this = this ;
			var url = '/NewActivity/getVocalKingList';
			var params = {
		...
		changeStatusSure(index){
			...
			if(index == 1){
				...
				this.$confirm('此操作将立即生效, 是否继续?', '提示', {
					...
					var url = '/NewActivity/setVocalKingStatus';
					let params = {
