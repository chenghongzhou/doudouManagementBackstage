		...
		:style="{height:tabHeight+'px'}">
			...
			style="padding-bottom:0px;">
				...
				:model="formOne">
					<el-form-item>
                        <span>豆豆模式：</span>
                        <el-select style="width:200px;" v-model="formOne.mode">
                            <el-option label="全部" value="0"></el-option>
                            <el-option label="普通" value="1"></el-option>
							<el-option label="暴走" value="2"></el-option>
                        </el-select>
                    </el-form-item>
					<el-form-item>
						<div class="block">
	...
	export default{
		...
		methods:{
			...
			getOneData(){
				...
				axios.get(allget+'/NewBean/getDateStat', {params: params})
				.then((res) => {
					if(res.data.ret == 1) {
						var oneTitleStatic = [];
						var arr = [];
			...
			getTwoData(){
				...
				axios.get(allget+'/NewBean/getUserStat', {params: params})
				.then((res) => {
					if(res.data.ret == 1) {
			...
			getThreeData(){
       			var _this = this;
				axios.get(allget+'/NewBean/getCheatList', {params: {status:0,page:_this.formThree.page}})
				.then((res) => {
					if(res.data.ret == 1) {
			...
			getFourData(){
       			var _this = this;
				axios.get(allget+'/NewBean/getCheatList', {params: {status:1,page:_this.formFour.page}})
				.then((res) => {
					if(res.data.ret == 1) {
			...
			checkSort(){
				var _this = this;
				let url = "/NewBean/getAvailablePrizeList";
				let params = {
