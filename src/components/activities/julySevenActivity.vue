	...
	<section>
		<template>
            ...
            :height="tableHeight">
				...
				<el-table-column prop="cp" label="当前情侣总数/对"></el-table-column>
                <el-table-column prop="new_cp" label="新增情侣数/对"></el-table-column>
				<el-table-column prop="love" label="热恋值总数"></el-table-column>
                <el-table-column prop="uv" label="页面访问人数/个"></el-table-column>
				<el-table-column prop="pv" label="页面访问次数"></el-table-column>
                <el-table-column prop="action" label="参与活动的人数"></el-table-column>
			</el-table>
...
export default {
	...
	methods: {
		...
		getTableData() {
            ...
            var url = '/NewActivity/getDoubleSeventhData';
			var params = {
