    ...
    <section>
            ...
            <el-form :inline="true" style="overflow:hidden;">
                <el-row>
                    ...
                    <!-- <el-form-item>
                        <el-button 
                        type="primary" 
                        @click="getData(0)">重新加载</el-button>
                    </el-form-item> -->
					<el-form-item>
                        <el-button 
                        type="primary" 
		...
		<el-dialog title="添加" :visible.sync="addNewloading.dialogFormVisible">
			<el-form :model="addNewloading.params"> 
				...
				<el-form-item label="兑换所需星星" :label-width="formLabelWidth">
					<el-input 
					style="width:250px"
        ...
        <el-dialog title="编辑" :visible.sync="editorloading.dialogFormVisible">
			<el-form :model="editorloading.params">
				...
				<el-form-item label="兑换所需星星" :label-width="formLabelWidth" disabled>
					<el-input 
					style="width:250px"
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            let url = "/NewTreasureBox/getShopList";
            let params = {
                page: _this.page,
            };
		...
		checkSort(){
			var _this = this;
			_this.getSort = [];
			let url = "/NewTreasureBox/getShopSortList";
            let params = {
		...
		addBannerSure(num){
			...
			if(num == 0){
				...
				formData.append('goods_id', _this.addNewloading.params.goods_id);
				...
				axios.post(allget+'/NewTreasureBox/setShop', formData, config)
					.then((res) => {
						_this.listLoading = false;							
						if(res.data.ret == 1) {	
							_this.addNewloading.dialogFormVisible = true;
        ...
        deleteContentRecord(index, row){
            ...
            this.$confirm('此操作将永久删除, 是否继续?', '提示', {
                ...
                var url = '/NewTreasureBox/deleteShop';
                let params = {
